...
- **GitHub Releases**: [https://github.com/hsliuping/TA/releases](https://github.com/hsliuping/TA/releases)
- **百度网盘**: 关注公众号 "TA" 获取下载链接
- **阿里云盘**: 关注公众号 "TA" 获取下载链接
...
2. **下载 docker-compose.yml**：
   ```bash
   # 从 GitHub 下载
   curl -O https://raw.githubusercontent.com/hsliuping/TA/main/docker-compose.yml
...
3. **创建 .env 文件**：
   ```bash
   # 复制示例配置
   curl -O https://raw.githubusercontent.com/hsliuping/TA/main/.env.example
   mv .env.example .env
...
1. **克隆代码**：
   ```bash
   git clone https://github.com/hsliuping/TA.git
   cd TA
   ```
...
1. **查看文档**: [docs/](../)
2. **GitHub Issues**: [https://github.com/hsliuping/TA/issues](https://github.com/hsliuping/TA/issues)
3. **微信公众号**: TA
4. **QQ 群**: 关注公众号获取群号
